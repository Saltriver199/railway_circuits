...
# === Main Draw Function ===
def draw_symbols(df, ax, ordered_circuit_ids, junction_name, start_x=1, pin_spacing=0.8, circuits_per_page=12, page_number=1, max_terminal_symbols_per_row=36, max_rows_visible=5, page_width=None):
    """
...
fixed_fig_height = 31.0 + 7.76 * (max_rows_for_ylim - 3)
...
with PdfPages(output_file) as pdf:
    for page_num, (junction_name, page_circuit_ids) in enumerate(pages, 1):
        ...
        x_positions, input_connected_flags, output_connected_flags = draw_symbols(
            ...
            max_terminal_symbols_per_row=36,
            max_rows_visible=5,  # enforce 4 visible rows; 5th row will be blank if triggered
